...
if __name__ == "__main__":
    ...
    if len(sys.argv) > 1 or True:
        ...
        FlowFileName = ReadInputFile(lines,'COMID_Flow_File') or ReadInputFile(lines,'Comid_Flow_File') or ReadInputFile(lines, 'Flow_File')
        ...
        LocalFloodOption = ReadInputFile(lines,'LocalFloodOption') or ReadInputFile(lines, 'Flood_Local')
