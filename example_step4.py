...
if __name__ == "__main__":
    ...
    SEED_Output_Text_File = r"C:\Users\jlgut\OneDrive\Desktop\FHS_OperationalFloodMapping\Bathy_Test_Curve2Flood_FABDEM_BanksBathy_Clean\FIST\MO_FABDEM_Seed.txt"
    ...
    SEED_Output_Shapefile = r"C:\Users\jlgut\OneDrive\Desktop\FHS_OperationalFloodMapping\Bathy_Test_Curve2Flood_FABDEM_BanksBathy_Clean\FIST\MO_FABDEM_Seed.shp"
    # True/False of whether or not to filter the output GeoJSON
    Thin_Output = True
    # Path to the DEM raster file (TIFF).
    DEM_Raster_File = r"C:\Users\jlgut\OneDrive\Desktop\FHS_OperationalFloodMapping\Bathy_Test_Curve2Flood_FABDEM_BanksBathy_Clean\Bathymetry\MO_FABDEM_FS_Bathy.tif"
