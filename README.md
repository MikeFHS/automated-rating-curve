...
## Getting started
Below are step-by-step instructions for running the ARC and generating rating curves.
...
```
cd existing_repo
git remote add origin http://100.8570.8/autoroute/automated_rating_curve_generator.git
git branch -M main
